...
export type SessionEntry = {
  ...
  /** Workspace explicitly set via x-openclaw-workspace header at session creation. Persisted so
   *  session resumption (e.g. subagent announce delivery) resolves the correct workspace. */
